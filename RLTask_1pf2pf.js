$(document).ready(function() {
	...
	var ExpName = 'OnlineMag_1pf2pf';
	var Language = "en";
	var CompLink = 1;
	var NumSessions = 1;
	var PostLearning = 1;	
	var	NbPostLearningTrials = 30;
	var NbTrainingTrials     = 6;
	var TrialsPerCondition   = 30;
	var Questionnaire = 1;
	...
	function EndPostLearning(){
		...
		if(Language=='en'){
			...
			Info = '<H3 align = "center">You have finished the cognitive phase of the experiment.<br>You '+ wonlost +toprint+' points = '+toprint/2+' pence!</h3><br><br>';	
			nextBut = '"Next"';
		}
		else if (Language=='fr'){
			wonlost = ' gagné ';
			...
			Info = '<H3 align = "center">Vous avez terminé la partie cognitive.<br>Vous avez'+ wonlost +toprint+' points = '+toprint/2+' centimes !</h3><br><br>';
			nextBut = '"Suivant"';
		}
